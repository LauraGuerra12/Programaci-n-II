...
def inicializar_inventario():
    ...
    productos = [
        ("Manzanas rojas", "Frutas", 300, 1, "libra"),
        ("Bananas", "Frutas", 150, 1, "libra"),
        ("Naranjas", "Frutas", 400, 12, "unidades"),
        ("Fresas", "Frutas", 500, 1, "libra"),
        ("Mangos", "Frutas", 250, 1, "unidad"),
        ("Uvas verdes", "Frutas", 400, 1, "libra"),
        ("Piña", "Frutas", 300, 1, "unidad"),
        ("Kiwis", "Frutas", 350, 4, "paquete"),
        ("Papayas", "Frutas", 300, 1, "unidad"),
        ("Peras", "Frutas", 250, 1, "libra"),
        ("Zanahorias", "Verduras", 200, 1, "libra"),
        ("Tomates", "Verduras", 250, 1, "libra"),
        ("Lechuga", "Verduras", 200, 1, "cabeza"),
        ("Papas", "Verduras", 300, 5, "bolsa"),
        ("Cebolla", "Verduras", 150, 1, "libra"),
        ("Pimientos rojos", "Verduras", 300, 1, "libra"),
        ("Brócoli", "Verduras", 250, 1, "libra"),
        ("Pechuga de pollo", "Cárnicos", 450, 1, "libra"),
        ("Carne de res molida", "Cárnicos", 600, 1, "libra"),
        ("Chuletas de cerdo", "Cárnicos", 500, 1, "libra"),
    ]
