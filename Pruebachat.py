...
def administrador():
    ...
    while a == "si":
        ...
        if usuario in V_admin:
            passw = input("Ingrese su contraseña: \n")
            if passw == V_admin[usuario]["contraseña"]:
                ...
                a = input("Contraseña incorrecta. Si desea volver a ingresar marque 'si', de lo contrario presione Enter para salir.\n")
        else:
            a = input("Usuario erróneo. Si desea volver a intentar marque 'si', de lo contrario presione Enter para salir.\n")
...
def cliente():
    ...
    if usuario in V_cliente:
        passw = input("Ingrese su contraseña: \n")
        if passw == V_cliente[usuario]["contraseña"]:
